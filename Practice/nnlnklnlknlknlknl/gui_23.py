# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 21:29:57 2019
...
class GeeksBro:
    ...
    def __init__(self, window):
        ...
        self.close_btn = tkinter.Button(window, text = "Close", command = window.destroy) # closing the 'window' when you click the button
        self.close_btn.pack()
